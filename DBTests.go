...
func test() error {
	...
	// updated_user, err := UpdateUser(createdUser.DbID, createdUser.Mention, createdUser.FirstName, createdUser.LastName, createdUser.Email, "papa peli more liek daady peli 🥺")
	// if err != nil {
	// 	panic(err)
	// }
